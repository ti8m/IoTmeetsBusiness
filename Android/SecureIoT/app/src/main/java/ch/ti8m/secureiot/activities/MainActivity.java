...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (apSsid != null) {
            ...
            edit_ssid.setText(apSsid);

        } else {

            edit_ssid.setText(getResources().getString(R.string.notConnected));
        }
    ...
    public void connect(View view) {
        ...
        String apSsid = edit_ssid.getText().toString();
    ...
    /**
     *  Subscribe for messages from a specific device
     */
    private void subscribeMqttTopic(String deviceMac){

        String topic = "secureIoT/" + deviceMac + "/state";
    ...
    /**
     *  Publish mqtt-command for the device
     */
    private void publishCommand(String command){

        String topic = "secureIoT/" + deviceMac + "/command";
...
//        });
        ...
        // subscribe for messages from the device
        subscribeMqttTopic(deviceMac);
    }
    ...
    private class EsptouchAsyncTask3 extends AsyncTask<String, Void, List<IEsptouchResult>> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage(getResources().getString(R.string.msgConnecting));
            ...
            mProgressDialog.setButton(DialogInterface.BUTTON_POSITIVE, buttonMessage, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    // publish DONE command for device
                    if (deviceMac != null) {
                        publishCommand("DONE");
                    }
                }
    ...
    public void test(View view){
        ...
        //String topic = "secureIoT/" + deviceMac + "/command";
        String topic = "secureIoT/" + "18fe34a37794" + "/command";
        String payload = "DONE";
        byte[] encodedPayload = new byte[0];
        try {
            encodedPayload = payload.getBytes("UTF-8");
